package com.example.campusin.domain.post.questionpost;
...
@SQLDelete(sql = "UPDATE QUESTIONPOST SET deleted_at = CURRENT_TIMESTAMP where id = ?")
@Getter
@Setter
...
public class QuestionPost extends BaseTimeEntity {
    ...
    @Builder
    public QuestionPost(Long id, String title, String content, Users writer) {
        this.id = id;
        this.title = title;
