package com.example.campusin.domain.post.studypost;
...
@SQLDelete(sql = "UPDATE STUDYPOST SET deleted_at = CURRENT_TIMESTAMP where id = ?")
@Getter
@Setter
...
public class StudyPost extends BaseTimeEntity {
    ...
    @Builder
    public StudyPost(Long id, String title, String content, Users writer) {
        this.id = id;
        this.title = title;
