                        ...
                        DispatchQueue.main.async {
                            ...
                            if(self!.postBlockResult?.block != nil){
                                self!.getPostDetail(postID: self!.postID!){
                                    ...
                                    self!.postDetail = postDetail
                                    self!.tableView.reloadData()
                                    let alert = UIAlertController(title: "알림", message: "블락 성공", preferredStyle: .alert)
                                ...
                                let alert = UIAlertController(title: "알림", message: "이미 블락 처리된 댓글 입니다.", preferredStyle: .alert)
                                let okAction = UIAlertAction(title: "확인", style: .default)
                                alert.addAction(okAction)
                                self!.present(alert, animated: true, completion: nil)
                    ...
                    case.success(let res):
                        DispatchQueue.main.async {
                            if(res.already == nil){
                                ...
                                print("이미 신고한 게시글")
                                let alert = UIAlertController(title: "이미 신고한 게시글", message: "이미 신고한 게시글 입니다.", preferredStyle: .alert)
                                let okAction = UIAlertAction(title: "확인", style: .default)
                                alert.addAction(okAction)
                                self.present(alert, animated: true, completion: nil)
                            }
