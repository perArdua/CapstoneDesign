...
class QuestionPostingViewController: UIViewController {
    ...
    @objc func addBtnTapped(){
        let nextVC = storyboard?.instantiateViewController(withIdentifier: "QuestionPostingAddViewController") as! QuestionPostingAddViewController
...
extension QuestionPostingViewController : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "QuestionPostingTableViewCell", for: indexPath) as! QuestionPostingTableViewCell
        ...
        cell.userLabel.text = "작성자: \(temp.nickname ?? "(null)")"
        cell.commentLabel.text = "5"
        cell.tagLabel.text = "#\(temp.tagResponse.tagType)"
