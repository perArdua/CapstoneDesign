//
//  StudyPostingSearchViewController.swift
//  CampusIn
//
...
class StudyPostingSearchViewController: UIViewController {
    ...
    func getData(keyword: String){
        BoardManager.searchPost(boardID: BoardManager.getBoardID(boardName: "Study"), keyword: keyword){result in
            switch result {
...
extension StudyPostingSearchViewController : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "StudyPostingSearchTableViewCell", for: indexPath) as! StudyPostingSearchTableViewCell
