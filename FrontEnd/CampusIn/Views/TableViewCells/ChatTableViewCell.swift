...
class ChatTableViewCell: UITableViewCell {
    ...
    func configure(with chatMessage: ChatMessage) {
        ...
        bubbleView?.backgroundColor = chatMessage.isSentByCurrentUser ? UIColor.systemBlue : UIColor.systemGray5
        messageLabel?.textColor = chatMessage.isSentByCurrentUser ? UIColor.white : UIColor.black
